...
**v-intl** (`@vinayakkulkarni/v-intl`) -- Native i18n components for Vue 3 apps using the Intl API.

- **Owner**: vinayakkulkarni
- **npm**: `@vinayakkulkarni/v-intl`
...
v-intl/
├── src/
│   ├── components/     # VIntl* components (DateTimeFormat, DisplayNames, DurationFormat, ListFormat, NumberFormat, RelativeTimeFormat)
...
|----------------------------------|------|
| `vue`                            | peer |
| `@formatjs/intl-durationformat`  | runtime |
